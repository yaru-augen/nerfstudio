...
class ExportGaussianSplat(Exporter):
    ...
    def main(self) -> None:
        ...
        # Name export after job/run folder to avoid many splat.ply collisions
        job_name = self.load_config.parent.name if self.load_config else "splat"
        filename = self.output_dir / f"{job_name}.ply"
